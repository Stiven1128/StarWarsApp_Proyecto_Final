                ...
                LazyColumn(
                    ...
                    items(starships) { starship ->
                        StarWarsCard(modifier = Modifier.fillMaxWidth()) {
                            ...
                            Text(
                                text = "📦 Modelo: ${starship.model}",
                                style = MaterialTheme.typography.bodyMedium,
                                color = MaterialTheme.colorScheme.onSurface
                            )
                            Text(
                                text = "🏭 Fabricante: ${starship.manufacturer}",
                                style = MaterialTheme.typography.bodyMedium,
                                color = MaterialTheme.colorScheme.onSurface
                            )
                            Text(
                                text = "💰 Costo: ${starship.cost_in_credits} créditos",
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant
                            )
                            Text(
                                text = "📏 Longitud: ${starship.length} m",
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant
                            )
                            Text(
                                text = "👨‍✈️ Tripulación: ${starship.crew}",
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant
                            )
                            Text(
                                text = "👥 Pasajeros: ${starship.passengers}",
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant
                            )
                        }
